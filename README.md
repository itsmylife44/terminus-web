...
```bash
curl -fsSL https://raw.githubusercontent.com/itsmylife44/terminus-web/v1.1.11/scripts/install.sh -o install.sh && sudo bash install.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/itsmylife44/terminus-web/v1.1.11/scripts/uninstall.sh -o uninstall.sh && sudo bash uninstall.sh
```
